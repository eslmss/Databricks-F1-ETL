...
constructors_final_df.write.format("delta").mode("overwrite").saveAsTable("f1_processed.constructors")

# COMMAND ----------

## display(spark.read.parquet("abfss://processed@formula1dl1610.dfs.core.windows.net/constructors"))
display(spark.read.format("delta").load("abfss://processed@formula1dl1610.dfs.core.windows.net/constructors"))
